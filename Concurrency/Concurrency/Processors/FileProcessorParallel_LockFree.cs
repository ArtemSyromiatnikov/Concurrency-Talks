...
{
    /// <summary>
    /// Redesign the logic to make it lock-free
    /// Instead of using shared variables for storing results,
    /// make each task calculate only his own results and then aggregate them in the end.
    /// </summary>
    public class FileProcessorParallel_LockFree : IFileProcessor
    {
